...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='"On Update" for Foreign Keys is not defined because "ID" that they refers should not be updated.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `artist_and_list`
--

LOCK TABLES `artist_and_list` WRITE;
/*!40000 ALTER TABLE `artist_and_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `artist_and_list` ENABLE KEYS */;
UNLOCK TABLES;
